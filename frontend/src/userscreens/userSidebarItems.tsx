...
export function getUserSidebarItems(navigation: any, closeSidebar: () => void, activeLabel?: string) {
  ...
  return [
    ...
    { label: 'Profile', icon: <Ionicons name="person-outline" size={20} color={getColor('Profile')} />, onPress: () => { closeSidebar(); navigation.navigate('Profile'); }, active: activeLabel === 'Profile' },
